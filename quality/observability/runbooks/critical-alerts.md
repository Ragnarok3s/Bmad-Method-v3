...
4. Seguir ação primária do alerta. Em caso de `AvailabilityDrop` ou `PlaybookErrorRate`, executar `scripts/finops/rollback_and_tag.py rollback` com o release afetado para iniciar reversão automatizada.
