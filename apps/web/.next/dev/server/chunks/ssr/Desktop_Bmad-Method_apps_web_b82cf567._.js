...
"[project]/Desktop/Bmad-Method/apps/web/services/api/playbooks.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function listPlaybooks(signal) {
    ...
    if (!response.ok) {
        ...
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$packages$2f$api$2d$client$2f$dist$2f$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CoreApiError"]('Failed to load playbooks', response.status, body);
    }
    const payload = await response.json();
    return payload.map(mapTemplate);
}
async function createPlaybook(payload) {
    const url = new URL('/playbooks', CORE_API_BASE_URL);
    const response = await fetch(url, {
        method: 'POST',
        headers: {
    ...
    if (!response.ok) {
        const body = await safeReadJson(response);
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$packages$2f$api$2d$client$2f$dist$2f$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CoreApiError"]('Failed to create playbook', response.status, body);
    }
    const dto = await response.json();
    return mapTemplate(dto);
}
async function executePlaybook(playbookId, initiatedBy) {
    ...
    const response = await fetch(url, {
        ...
        body: JSON.stringify({
            initiated_by: initiatedBy ?? 'web-app',
            context: {}
        })
    });
    if (!response.ok) {
        const body = await safeReadJson(response);
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$packages$2f$api$2d$client$2f$dist$2f$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CoreApiError"]('Failed to execute playbook', response.status, body);
    }
    const dto = await response.json();
    return {
        runId: dto.run_id,
...
"[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$playbooks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Bmad-Method/apps/web/services/api/playbooks.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$housekeeping$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/Desktop/Bmad-Method/apps/web/services/api/housekeeping.ts [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$packages$2f$api$2d$client$2f$dist$2f$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Bmad-Method/packages/api-client/dist/core.js [app-ssr] (ecmascript)");
'use client';
;
...
function PlaybooksPage() {
    const [playbooks, setPlaybooks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [search, setSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [activeTags, setActiveTags] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(new Set());
    const [executingId, setExecutingId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [executionFeedback, setExecutionFeedback] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        setLoading(true);
        setError(null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$playbooks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["listPlaybooks"])(controller.signal).then((templates)=>{
            ...
            if (apiError instanceof __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$packages$2f$api$2d$client$2f$dist$2f$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CoreApiError"]) {
                setError(apiError.status >= 500 ? 'Serviço de playbooks indisponível. Tente novamente em instantes.' : 'Não foi possível carregar a biblioteca de playbooks.');
            } else {
    ...
    const tags = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    const filteredPlaybooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const normalizedSearch = search.trim().toLowerCase();
        return playbooks.filter((template)=>{
            const matchesSearch = normalizedSearch.length === 0 || template.name.toLowerCase().includes(normalizedSearch) || template.summary.toLowerCase().includes(normalizedSearch) || template.steps.some((step)=>step.toLowerCase().includes(normalizedSearch));
            const matchesTags = activeTags.size === 0 || template.tags.some((tag)=>activeTags.has(tag));
    ...
    const handleExecute = async (playbook)=>{
        ...
        try {
            const execution = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$playbooks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["executePlaybook"])(playbook.id, 'web-playbooks');
            setExecutionFeedback((current)=>({
                    ...current,
                    [playbook.id]: {
                        status: 'success',
            ...
            setPlaybooks((current)=>current.map((template)=>template.id === playbook.id ? {
                        ...template,
                        executionCount: template.executionCount + 1,
                        lastExecutedAt: execution.finishedAt ?? execution.startedAt
                    } : template));
        } catch (apiError) {
            const message = apiError instanceof __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$packages$2f$api$2d$client$2f$dist$2f$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CoreApiError"] && apiError.status >= 500 ? 'Falha ao contactar o orquestrador de playbooks.' : 'Não foi possível iniciar a execução. Tente novamente.';
            setExecutionFeedback((current)=>({
                    ...current,
                    [playbook.id]: {
                        status: 'error',
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "jsx-ec744b64942683fa" + " " + "playbooks-page",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$layout$2f$SectionHeader$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SectionHeader"], {
                ...
                actions: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                    type: "search",
                    value: search,
                    ...
                    className: "jsx-ec744b64942683fa"
                }, void 0, false, {
                    fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
                    lineNumber: 156,
                    columnNumber: 11
                }, void 0),
                children: "Playbooks automatizados"
            }, void 0, false, {
                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
                lineNumber: 153,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                role: "group",
                "aria-label": "Filtros por tag",
                className: "jsx-ec744b64942683fa" + " " + "toolbar",
                children: [
                    tags.map((tag)=>{
                        const isActive = activeTags.has(tag);
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            type: "button",
                            onClick: ()=>handleToggleTag(tag),
                            "data-active": isActive,
                            "data-testid": "playbook-tag-filter",
                            "data-tag": tag,
                            className: "jsx-ec744b64942683fa" + " " + ((isActive ? 'tag active' : 'tag') || ""),
                            children: [
                                "#",
                                tag
                            ]
                    ...
                    tags.length === 0 && !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: "jsx-ec744b64942683fa" + " " + "empty-tags",
                        children: "Nenhuma tag cadastrada ainda."
                    }, void 0, false, {
                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
                        lineNumber: 187,
                        columnNumber: 11
            ...
            error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                role: "alert",
                className: "jsx-ec744b64942683fa" + " " + "error",
                children: error
            }, void 0, false, {
                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
                lineNumber: 191,
            ...
            loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "jsx-ec744b64942683fa" + " " + "loading",
                children: "A carregar playbooks…"
            }, void 0, false, {
                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
                lineNumber: 192,
                columnNumber: 19
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$layout$2f$ResponsiveGrid$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ResponsiveGrid"], {
                ...
                children: [
                    filteredPlaybooks.map((playbook)=>{
                        ...
                        const lastRunLabel = hasExecutions ? `Última execução ${playbook.lastExecutedAt ? DATE_TIME_FORMATTER.format(new Date(playbook.lastExecutedAt)) : 'não registrada'}` : 'Ainda não executado';
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    className: "jsx-ec744b64942683fa" + " " + "card-header",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$StatusBadge$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StatusBadge"], {
                                            variant: hasExecutions ? 'success' : 'neutral',
                                            children: hasExecutions ? `${playbook.executionCount} execuções registradas` : 'Novo template'
                                        }, void 0, false, {
                                            fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
                                            lineNumber: 210,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "jsx-ec744b64942683fa" + " " + "last-run",
                                            children: lastRunLabel
                                        }, void 0, false, {
                                            fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
                                            lineNumber: 215,
                                            columnNumber: 17
                                ...
                                playbook.tags.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                    "aria-label": `Tags do playbook ${playbook.name}`,
                                    className: "jsx-ec744b64942683fa" + " " + "tags",
                                    children: playbook.tags.map((tag)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                            className: "jsx-ec744b64942683fa",
                                            children: [
                                                "#",
                                                tag
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ol", {
                                    className: "jsx-ec744b64942683fa" + " " + "steps",
                                    children: playbook.steps.map((step)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                            className: "jsx-ec744b64942683fa",
                                            children: step
                                        }, step, false, {
                                            fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "jsx-ec744b64942683fa" + " " + "run-button",
                                    children: executingId === playbook.id ? 'A iniciar…' : 'Iniciar execução'
                                }, void 0, false, {
                                    fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
                                    lineNumber: 229,
                                    columnNumber: 15
                                }, this),
                                feedback && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    "data-testid": "playbook-feedback",
                                    className: "jsx-ec744b64942683fa" + " " + `feedback ${feedback.status}`,
                                    children: [
                                        feedback.message,
                                        feedback.payload && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "jsx-ec744b64942683fa" + " " + "run-id",
                                            children: [
                                                " Referência: ",
                                                feedback.payload.runId
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
                                            lineNumber: 242,
                    ...
                    !loading && filteredPlaybooks.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "jsx-ec744b64942683fa",
                            children: "Experimente ajustar a pesquisa ou remover filtros de tags."
                        }, void 0, false, {
                            fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
                            lineNumber: 251,
                            columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                id: "ec744b64942683fa",
                children: ".playbooks-page.jsx-ec744b64942683fa{gap:var(--space-6);display:grid}input[type=search].jsx-ec744b64942683fa{border:1px solid var(--color-neutral-4);border-radius:var(--radius-sm);min-width:280px;padding:var(--space-2)var(--space-3);font-size:.95rem}.toolbar.jsx-ec744b64942683fa{gap:var(--space-3);flex-wrap:wrap;align-items:center;display:flex}.tag.jsx-ec744b64942683fa{border:1px solid var(--color-neutral-4);border-radius:var(--radius-pill);padding:0 var(--space-3);background:var(--color-neutral-0);cursor:pointer;height:32px;font-weight:600}.tag.active.jsx-ec744b64942683fa,.tag[data-active=true].jsx-ec744b64942683fa{background:var(--color-deep-blue);color:#fff;border-color:var(--color-deep-blue)}.empty-tags.jsx-ec744b64942683fa{color:var(--color-neutral-3);font-size:.9rem}.error.jsx-ec744b64942683fa{color:var(--color-coral);font-weight:600}.loading.jsx-ec744b64942683fa{color:var(--color-neutral-2)}.card-header.jsx-ec744b64942683fa{justify-content:space-between;align-items:center;gap:var(--space-3);display:flex}.last-run.jsx-ec744b64942683fa{color:var(--color-neutral-3);font-size:.85rem}.tags.jsx-ec744b64942683fa{gap:var(--space-2);flex-wrap:wrap;margin:0;padding:0;list-style:none;display:flex}.tags.jsx-ec744b64942683fa li.jsx-ec744b64942683fa{color:var(--color-deep-blue);padding:0 var(--space-2);border-radius:var(--radius-sm);background:#2563eb14;font-size:.75rem;font-weight:600}.steps.jsx-ec744b64942683fa{padding-left:var(--space-5);gap:var(--space-2);margin:0;display:grid}.run-button.jsx-ec744b64942683fa{background:var(--color-deep-blue);color:#fff;border-radius:var(--radius-sm);padding:var(--space-2)var(--space-4);cursor:pointer;border:none;font-weight:600}.run-button.jsx-ec744b64942683fa:disabled{opacity:.6;cursor:not-allowed}.feedback.jsx-ec744b64942683fa{margin:0;font-size:.85rem}.feedback.success.jsx-ec744b64942683fa{color:var(--color-soft-aqua)}.feedback.error.jsx-ec744b64942683fa{color:var(--color-coral)}.run-id.jsx-ec744b64942683fa{margin-top:var(--space-1);color:var(--color-neutral-3);font-size:.75rem;display:block}@media (width<=1024px){input[type=search].jsx-ec744b64942683fa{width:100%}.card-header.jsx-ec744b64942683fa{flex-direction:column;align-items:flex-start}}"
            }, void 0, false, void 0, this)
        ]
    }, void 0, true, {
        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/playbooks/page.tsx",
...
//# sourceMappingURL=Desktop_Bmad-Method_apps_web_b82cf567._.js.map