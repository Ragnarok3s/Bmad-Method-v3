...
"[project]/Desktop/Bmad-Method/apps/web/services/api/owners.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const FALLBACK_OWNER_ID = Number(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_OWNER_ID ?? '1');
const DEFAULT_OWNER_TOKEN = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_OWNER_TOKEN ?? 'demo-owner-token';
...
async function requestJson(path, token, init = {}) {
    ...
    if (!response.ok) {
        ...
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$packages$2f$api$2d$client$2f$dist$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CoreApiError"]('Failed to call owner endpoint', response.status, body);
    }
...
function mapPayoutPreferences(dto) {
    return {
        method: dto.method,
...
async function fetchOwnerOverview(ownerId, token) {
    try {
        const payload = await requestJson(`/owners/${ownerId}/overview`, token);
        const mapped = mapOverview(payload);
        FALLBACK_STATE.overview = {
            ...mapped
        };
        return mapped;
    } catch (error) {
...
async function fetchOwnerProperties(ownerId, token) {
    try {
        const payload = await requestJson(`/owners/${ownerId}/properties`, token);
        const mapped = payload.map(mapProperty);
        FALLBACK_STATE.properties = [
            ...mapped
        ];
        return mapped;
    } catch (error) {
...
async function fetchOwnerInvoices(ownerId, token) {
    try {
        const payload = await requestJson(`/owners/${ownerId}/invoices`, token);
        const mapped = payload.map(mapInvoice);
        FALLBACK_STATE.invoices = [
            ...mapped
        ];
        return mapped;
    } catch (error) {
...
async function fetchOwnerReports(ownerId, token) {
    try {
        const payload = await requestJson(`/owners/${ownerId}/reports`, token);
        const mapped = payload.map(mapReport);
        FALLBACK_STATE.reports = [
            ...mapped
        ];
        return mapped;
    } catch (error) {
...
async function fetchOwnerNotifications(ownerId, token) {
    try {
        const payload = await requestJson(`/owners/${ownerId}/notifications`, token);
        const mapped = payload.map(mapNotification);
        FALLBACK_STATE.notifications = [
            ...mapped
        ];
        return mapped;
    } catch (error) {
...
async function updateOwnerPayoutPreferences(ownerId, token, payload) {
    ...
    try {
        const response = await requestJson(`/owners/${ownerId}/payout-preferences`, token, {
            method: 'POST',
            headers: {
        ...
        FALLBACK_STATE.overview.payoutPreferences = {
            ...mapped
        };
...
async function uploadOwnerDocument(ownerId, token, file, documentType) {
    const formData = new FormData();
    formData.append('file', file);
    try {
        const response = await requestJson(`/owners/${ownerId}/kyc-documents`, token, {
            method: 'POST',
            body: formData
        });
...
function resolveOwnerToken(token) {
...
"[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$owners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Bmad-Method/apps/web/services/api/owners.ts [app-client] (ecmascript)");
...
function OwnersOverviewPage() {
    _s();
    const { ownerId, token } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$app$2f$owners$2f$OwnerAccessContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOwnerAccess"])();
    const { t, locale } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$lib$2f$i18n$2f$useTranslation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"])('owners.overview');
    const [overview, setOverview] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [notifications, setNotifications] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [feedback, setFeedback] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [uploadFeedback, setUploadFeedback] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [documentType, setDocumentType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('identidade');
    const resolvedToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OwnersOverviewPage.useMemo[resolvedToken]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$owners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveOwnerToken"])(token)
    }["OwnersOverviewPage.useMemo[resolvedToken]"], [
        token
    ]);
    const [payoutForm, setPayoutForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const metricsCurrency = overview?.payoutPreferences.currency ?? 'EUR';
    const currencyFormatter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OwnersOverviewPage.useMemo[currencyFormatter]": ()=>new Intl.NumberFormat(locale, {
                style: 'currency',
                currency: metricsCurrency
            })
    }["OwnersOverviewPage.useMemo[currencyFormatter]"], [
        locale,
        metricsCurrency
    ]);
    const percentFormatter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OwnersOverviewPage.useMemo[percentFormatter]": ()=>new Intl.NumberFormat(locale, {
                style: 'percent',
                minimumFractionDigits: 0,
                maximumFractionDigits: 0
            })
    }["OwnersOverviewPage.useMemo[percentFormatter]"], [
        locale
    ]);
    const integerFormatter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OwnersOverviewPage.useMemo[integerFormatter]": ()=>new Intl.NumberFormat(locale)
    }["OwnersOverviewPage.useMemo[integerFormatter]"], [
        locale
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OwnersOverviewPage.useEffect": ()=>{
            ...
            async function load() {
                try {
                    ...
                    const [overviewData, notificationData] = await Promise.all([
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$owners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchOwnerOverview"])(ownerId, resolvedToken),
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$owners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchOwnerNotifications"])(ownerId, resolvedToken)
                    ]);
            ...
            load();
            return ({
                "OwnersOverviewPage.useEffect": ()=>abort.abort()
            })["OwnersOverviewPage.useEffect"];
        }
    }["OwnersOverviewPage.useEffect"], [
        ownerId,
    ...
    const handlePayoutSubmit = async (event)=>{
        ...
        try {
            setFeedback(null);
            setError(null);
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$owners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateOwnerPayoutPreferences"])(ownerId, resolvedToken, payoutForm);
            setOverview((current)=>current ? {
                    ...current,
                    payoutPreferences: updated,
                    pendingVerifications: updated.manualReviewRequired ? current.pendingVerifications + 1 : current.pendingVerifications,
                    complianceStatus: updated.manualReviewRequired ? 'pending' : current.complianceStatus
                } : current);
            const notificationData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$owners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchOwnerNotifications"])(ownerId, resolvedToken);
            setNotifications(notificationData);
    ...
    const handleDocumentUpload = async (event)=>{
        ...
        const fileInput = form.elements.namedItem('documento');
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$owners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadOwnerDocument"])(ownerId, resolvedToken, file, documentType);
            const [overviewData, notificationData] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$owners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchOwnerOverview"])(ownerId, resolvedToken),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$services$2f$api$2f$owners$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchOwnerNotifications"])(ownerId, resolvedToken)
            ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "jsx-11b8d0bc189baf6a" + " " + "owners-overview",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$layout$2f$SectionHeader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SectionHeader"], {
                ...
                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                lineNumber: 165,
                columnNumber: 7
            }, this),
            error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                role: "alert",
                className: "jsx-11b8d0bc189baf6a" + " " + "owners-error",
                children: error
            }, void 0, false, {
                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                lineNumber: 168,
            ...
            loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "jsx-11b8d0bc189baf6a" + " " + "owners-loading",
                children: t('loading')
            }, void 0, false, {
                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                lineNumber: 169,
            ...
            !loading && overview && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$layout$2f$ResponsiveGrid$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResponsiveGrid"], {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        "data-testid": "owner-overview-metric-occupancy",
                                        className: "jsx-11b8d0bc189baf6a" + " " + "owners-metric",
                                        children: percentFormatter.format(overview.metrics.occupancyRate)
                                    }, void 0, false, {
                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                        lineNumber: 178,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "jsx-11b8d0bc189baf6a" + " " + "owners-muted",
                                        children: t('cards.occupancy.properties', {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        "data-testid": "owner-overview-metric-revenue",
                                        className: "jsx-11b8d0bc189baf6a" + " " + "owners-metric",
                                        children: currencyFormatter.format(overview.metrics.revenueMtd)
                                    }, void 0, false, {
                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                        lineNumber: 192,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        "data-testid": "owner-overview-metric-compliance",
                                        className: "jsx-11b8d0bc189baf6a" + " " + "owners-metric",
                                        children: overview.complianceStatus === 'clear' ? t('cards.compliance.clear') : t('cards.compliance.pending')
                                    }, void 0, false, {
                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                        lineNumber: 206,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "jsx-11b8d0bc189baf6a" + " " + "owners-muted",
                                        children: t('cards.compliance.summary', {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-11b8d0bc189baf6a" + " " + "owners-panels",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                title: t('cards.payout.title'),
                                description: t('cards.payout.description'),
                                children: [
                                    feedback && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        "data-testid": "owner-update-feedback",
                                        className: "jsx-11b8d0bc189baf6a" + " " + "owners-feedback",
                                        children: feedback
                                    }, void 0, false, {
                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                        lineNumber: 226,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                        ...
                                        className: "jsx-11b8d0bc189baf6a" + " " + "owners-form",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                htmlFor: "beneficiary",
                                                className: "jsx-11b8d0bc189baf6a",
                                                children: t('cards.payout.labels.beneficiary')
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                lineNumber: 231,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                htmlFor: "method",
                                                className: "jsx-11b8d0bc189baf6a",
                                                children: t('cards.payout.labels.method')
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                lineNumber: 239,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: "bank_transfer",
                                                        className: "jsx-11b8d0bc189baf6a",
                                                        children: t('cards.payout.options.bank_transfer')
                                                    }, void 0, false, {
                                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                        lineNumber: 247,
                                                        columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: "pix",
                                                        className: "jsx-11b8d0bc189baf6a",
                                                        children: t('cards.payout.options.pix')
                                                    }, void 0, false, {
                                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                        lineNumber: 248,
                                                        columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: "paypal",
                                                        className: "jsx-11b8d0bc189baf6a",
                                                        children: t('cards.payout.options.paypal')
                                                    }, void 0, false, {
                                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                        lineNumber: 249,
                                                        columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                htmlFor: "iban",
                                                className: "jsx-11b8d0bc189baf6a",
                                                children: t('cards.payout.labels.lastDigits')
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                lineNumber: 251,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                htmlFor: "currency",
                                                className: "jsx-11b8d0bc189baf6a",
                                                children: t('cards.payout.labels.currency')
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                lineNumber: 261,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                htmlFor: "threshold",
                                                className: "jsx-11b8d0bc189baf6a",
                                                children: t('cards.payout.labels.threshold')
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                lineNumber: 268,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                htmlFor: "schedule",
                                                className: "jsx-11b8d0bc189baf6a",
                                                children: t('cards.payout.labels.schedule')
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                lineNumber: 278,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: "monthly",
                                                        className: "jsx-11b8d0bc189baf6a",
                                                        children: t('cards.payout.options.monthly')
                                                    }, void 0, false, {
                                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                        lineNumber: 285,
                                                        columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: "weekly",
                                                        className: "jsx-11b8d0bc189baf6a",
                                                        children: t('cards.payout.options.weekly')
                                                    }, void 0, false, {
                                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                        lineNumber: 286,
                                                        columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                type: "submit",
                                                className: "jsx-11b8d0bc189baf6a",
                                                children: t('cards.payout.submit')
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                lineNumber: 288,
                                                columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                ...
                                                className: "jsx-11b8d0bc189baf6a",
                                                children: t('cards.documents.labels.type')
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                lineNumber: 297,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: "identidade",
                                                        className: "jsx-11b8d0bc189baf6a",
                                                        children: t('cards.documents.options.identidade')
                                                    }, void 0, false, {
                                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                        lineNumber: 303,
                                                        columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: "comprovativo-bancario",
                                                        className: "jsx-11b8d0bc189baf6a",
                                                        children: t('cards.documents.options.comprovativo-bancario')
                                                    }, void 0, false, {
                                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                        lineNumber: 304,
                                                        columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        ...
                                                        className: "jsx-11b8d0bc189baf6a",
                                                        children: t('cards.documents.options.contrato-social')
                                                    }, void 0, false, {
                                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                        lineNumber: 305,
                                                        columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                htmlFor: "documento",
                                                className: "jsx-11b8d0bc189baf6a",
                                                children: t('cards.documents.labels.file')
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                lineNumber: 307,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                type: "submit",
                                                className: "jsx-11b8d0bc189baf6a",
                                                children: t('cards.documents.submit')
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                lineNumber: 309,
                                                columnNumber: 17
                                    ...
                                    uploadFeedback && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        "data-testid": "owner-document-upload-feedback",
                                        className: "jsx-11b8d0bc189baf6a" + " " + "owners-feedback",
                                        children: uploadFeedback
                                    }, void 0, false, {
                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                        lineNumber: 312,
                                        columnNumber: 17
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                            ...
                            className: "jsx-11b8d0bc189baf6a" + " " + "owners-notifications",
                            children: [
                                notifications.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                    className: "jsx-11b8d0bc189baf6a",
                                    children: t('cards.notifications.empty')
                                }, void 0, false, {
                                    fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                    lineNumber: 324,
                                    columnNumber: 46
                                }, this),
                                notifications.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                        "data-read": item.read,
                                        className: "jsx-11b8d0bc189baf6a",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "jsx-11b8d0bc189baf6a" + " " + "owners-notification-title",
                                                children: item.title
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
                                                lineNumber: 327,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "jsx-11b8d0bc189baf6a" + " " + "owners-notification-message",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "jsx-11b8d0bc189baf6a" + " " + "owners-notification-meta",
                                                children: t('cards.notifications.meta', {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                id: "11b8d0bc189baf6a",
                children: ".owners-overview.jsx-11b8d0bc189baf6a{gap:var(--space-5);display:grid}.owners-error.jsx-11b8d0bc189baf6a{color:var(--color-coral);margin:0}.owners-loading.jsx-11b8d0bc189baf6a{color:var(--color-neutral-2)}.owners-metric.jsx-11b8d0bc189baf6a{margin:0;font-size:2rem;font-weight:700}.owners-muted.jsx-11b8d0bc189baf6a{color:var(--color-neutral-2);margin:0}.owners-panels.jsx-11b8d0bc189baf6a{gap:var(--space-4);grid-template-columns:repeat(2,minmax(0,1fr));display:grid}.owners-form.jsx-11b8d0bc189baf6a{gap:var(--space-3);display:grid}.owners-form.jsx-11b8d0bc189baf6a input.jsx-11b8d0bc189baf6a,.owners-form.jsx-11b8d0bc189baf6a select.jsx-11b8d0bc189baf6a{border-radius:var(--radius-sm);padding:var(--space-3)var(--space-4);border:1px solid #2563eb33;font-size:1rem}.owners-form.jsx-11b8d0bc189baf6a button.jsx-11b8d0bc189baf6a{border-radius:var(--radius-sm);padding:var(--space-3)var(--space-4);background:var(--color-deep-blue);color:#fff;cursor:pointer;border:none;font-weight:600}.owners-feedback.jsx-11b8d0bc189baf6a{color:var(--color-deep-blue);margin:0;font-weight:600}.owners-notifications.jsx-11b8d0bc189baf6a{gap:var(--space-3);margin:0;padding:0;list-style:none;display:grid}.owners-notifications.jsx-11b8d0bc189baf6a li.jsx-11b8d0bc189baf6a{border-radius:var(--radius-sm);padding:var(--space-3)var(--space-4);background:#2563eb0a;border:1px solid #2563eb1f}.owners-notifications.jsx-11b8d0bc189baf6a li[data-read=false].jsx-11b8d0bc189baf6a{background:#0ea5e91f;border-color:#0ea5e999}.owners-notification-title.jsx-11b8d0bc189baf6a{margin:0;font-weight:600}.owners-notification-message.jsx-11b8d0bc189baf6a{margin:var(--space-2)0}.owners-notification-meta.jsx-11b8d0bc189baf6a{color:var(--color-neutral-2);margin:0;font-size:.875rem}@media (width<=960px){.owners-panels.jsx-11b8d0bc189baf6a{grid-template-columns:minmax(0,1fr)}}"
            }, void 0, false, void 0, this)
        ]
    }, void 0, true, {
        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/owners/page.tsx",
...
_s(OwnersOverviewPage, "uXLj28zezlPUpn8Q2xDyDn92/VA=", false, function() {
    return [
...
_c = OwnersOverviewPage;
var _c;
__turbopack_context__.k.register(_c, "OwnersOverviewPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Desktop_Bmad-Method_apps_web_0a26a16a._.js.map