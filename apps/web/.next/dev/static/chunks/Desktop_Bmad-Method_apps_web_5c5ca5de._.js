...
"[project]/Desktop/Bmad-Method/apps/web/app/recommendations/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const recommendationDataset = [
    {
        ...
        explainability: [
            {
                signal: 'reservas',
                description: 'Check-in previsto em 3h.',
                weight: 0.92
            },
            {
                signal: 'housekeeping',
                description: '2 tarefas bloqueadas aguardando manutenção.',
                weight: 0.88
            }
        ],
        actions: [
            'Acionar playbook Limpeza Acelerada',
            'Notificar manutenção e housekeeping'
        ],
        metadata: {
            property: 'Aurora Suites',
            tarefasCriticas: 2
        }
    },
    {
        ...
        explainability: [
            {
                signal: 'telemetria',
                description: 'Tempo atual em 70 minutos vs alvo de 30.',
                weight: 0.7
            },
            {
                signal: 'sla',
                description: 'Status AT_RISK reportado pela integração do parceiro.',
                weight: 0.68
            }
        ],
        actions: [
            'Acionar plano de contingência',
            'Revisar escala de suporte do parceiro'
        ],
        metadata: {
            parceiro: 'Horizon Ops',
    ...
    },
    {
        ...
        explainability: [
            {
                signal: 'reservas',
                description: 'Check-in atrasado há 2h.',
                weight: 0.84
            },
            {
                signal: 'housekeeping',
                description: 'Equipe aguardando confirmação para liberar unidade.',
                weight: 0.52
            }
        ],
        actions: [
            'Contactar hóspede imediatamente',
            'Liberar inventário caso não haja resposta'
        ],
        metadata: {
            apartamento: '1204A',
            origem: 'OTA - Booking'
    ...
    },
    {
        ...
        explainability: [
            {
                signal: 'reservas',
                description: 'Grupo corporativo com chegada em 10h.',
                weight: 0.55
            },
            {
                signal: 'housekeeping',
                description: '3 tarefas pendentes e 1 bloqueada por avaria.',
                weight: 0.58
            }
        ],
        actions: [
            'Reforçar turno extra',
            'Delegar inspeção final a supervisor'
        ],
        metadata: {
            unidadesPendentes: 3,
            prioridade: 'corporativo'
        }
    }
];
...
function mapPriorityToVariant(priority) {
    switch(priority){
        case 'high':
            return 'critical';
        case 'medium':
...
function RecommendationsPage() {
    _s();
    const [priorityFilter, setPriorityFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    const [domainFilter, setDomainFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    const [decisions, setDecisions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "RecommendationsPage.useState": ()=>{
            return Object.fromEntries(recommendationDataset.map({
                "RecommendationsPage.useState": (item)=>[
                        item.key,
                        'pending'
                    ]
            }["RecommendationsPage.useState"]));
    ...
    const [search, setSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const filteredRecommendations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RecommendationsPage.useMemo[filteredRecommendations]": ()=>{
            return recommendationDataset.filter({
                "RecommendationsPage.useMemo[filteredRecommendations]": (item)=>{
    ...
    const summary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RecommendationsPage.useMemo[summary]": ()=>{
            const values = Object.values(decisions);
            const approvals = values.filter({
                "RecommendationsPage.useMemo[summary]": (value)=>value === 'approved'
            }["RecommendationsPage.useMemo[summary]"]).length;
            const rejections = values.filter({
                "RecommendationsPage.useMemo[summary]": (value)=>value === 'rejected'
            }["RecommendationsPage.useMemo[summary]"]).length;
            const pending = values.filter({
                "RecommendationsPage.useMemo[summary]": (value)=>value === 'pending'
            }["RecommendationsPage.useMemo[summary]"]).length;
            return {
                approvals,
                rejections,
    ...
    function handleDecision(key, decision) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "jsx-c78748c6da78fa15",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$layout$2f$SectionHeader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SectionHeader"], {
                subtitle: "Combine insights operacionais e feedback humano para evoluir as heurísticas do motor.",
                children: "Recomendações Inteligentes"
            }, void 0, false, {
                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/recommendations/page.tsx",
                lineNumber: 156,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    role: "status",
                    "aria-live": "polite",
                    className: "jsx-c78748c6da78fa15" + " " + "summary-grid",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "jsx-c78748c6da78fa15",
                            children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                ...
                description: "Refine o foco por severidade, domínio operacional ou pesquisa livre.",
                accent: "info",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "jsx-c78748c6da78fa15" + " " + "filters",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "jsx-c78748c6da78fa15" + " " + "filter-group",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "jsx-c78748c6da78fa15",
                                    children: "Prioridade"
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    className: "jsx-c78748c6da78fa15" + " " + "chip-group",
                                    children: priorityFilters.map((filter)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            type: "button",
                                            onClick: ()=>setPriorityFilter(filter.value),
                                            className: "jsx-c78748c6da78fa15" + " " + `chip ${priorityFilter === filter.value ? 'active' : ''}`,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    className: "jsx-c78748c6da78fa15" + " " + "chip-group",
                                    children: domainFilters.map((filter)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            type: "button",
                                            onClick: ()=>setDomainFilter(filter.value),
                                            className: "jsx-c78748c6da78fa15" + " " + `chip ${domainFilter === filter.value ? 'active' : ''}`,
                                            children: filter.label
                                        }, filter.value, false, {
                                            fileName: "[project]/Desktop/Bmad-Method/apps/web/app/recommendations/page.tsx",
                                            lineNumber: 200,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                            className: "jsx-c78748c6da78fa15" + " " + "search",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "jsx-c78748c6da78fa15" + " " + "sr-only",
                                    children: "Pesquisar recomendação"
                                }, void 0, false, {
                                    fileName: "[project]/Desktop/Bmad-Method/apps/web/app/recommendations/page.tsx",
                                    lineNumber: 212,
                                    columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$layout$2f$SectionHeader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SectionHeader"], {
                subtitle: "Revise justificativas, ajuste prioridades e dispare ações com transparência.",
                children: "Recomendações em tempo real"
            }, void 0, false, {
                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/recommendations/page.tsx",
                lineNumber: 222,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$layout$2f$ResponsiveGrid$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResponsiveGrid"], {
                columns: 2,
                children: filteredRecommendations.map((item)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-c78748c6da78fa15" + " " + "header",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$StatusBadge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StatusBadge"], {
                                        variant: mapPriorityToVariant(item.priority),
                                        children: [
                                            "Prioridade ",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        "aria-label": `Score de prioridade ${item.score.toFixed(2)}`,
                                        className: "jsx-c78748c6da78fa15" + " " + "score",
                                        children: [
                                            "Score ",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-c78748c6da78fa15" + " " + "explainability",
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        className: "jsx-c78748c6da78fa15",
                                        children: item.explainability.map((detail)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                className: "jsx-c78748c6da78fa15",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                        className: "jsx-c78748c6da78fa15",
                                                        children: detail.signal
                                                    }, void 0, false, {
                                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/recommendations/page.tsx",
                                                        lineNumber: 246,
                                                        columnNumber: 23
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "jsx-c78748c6da78fa15" + " " + "weight",
                                                        children: [
                                                            "Contribuição ",
                                                            formatPercent(detail.weight)
                                                        ]
                                                    }, void 0, true, {
                                                        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/recommendations/page.tsx",
                                                        lineNumber: 248,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-c78748c6da78fa15" + " " + "actions",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                        className: "jsx-c78748c6da78fa15",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        className: "jsx-c78748c6da78fa15",
                                        children: item.actions.map((action)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                className: "jsx-c78748c6da78fa15",
                                                children: action
                                            }, action, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/recommendations/page.tsx",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                className: "jsx-c78748c6da78fa15" + " " + "decision-bar",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$apps$2f$web$2f$components$2f$ui$2f$StatusBadge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StatusBadge"], {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "jsx-c78748c6da78fa15" + " " + "buttons",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                className: "jsx-c78748c6da78fa15" + " " + `decision-button approve ${decision === 'approved' ? 'selected' : ''}`,
                                                children: "Aprovar"
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/recommendations/page.tsx",
                                                lineNumber: 264,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                className: "jsx-c78748c6da78fa15" + " " + `decision-button reject ${decision === 'rejected' ? 'selected' : ''}`,
                                                children: "Rejeitar"
                                            }, void 0, false, {
                                                fileName: "[project]/Desktop/Bmad-Method/apps/web/app/recommendations/page.tsx",
                                                lineNumber: 271,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("dl", {
                                className: "jsx-c78748c6da78fa15" + " " + "metadata",
                                children: Object.entries(item.metadata).map(([key, value])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "jsx-c78748c6da78fa15",
                                        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Bmad$2d$Method$2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                id: "c78748c6da78fa15",
                children: ".summary-grid.jsx-c78748c6da78fa15{gap:var(--space-4);grid-template-columns:repeat(3,minmax(0,1fr));display:grid}.summary-grid.jsx-c78748c6da78fa15 p.jsx-c78748c6da78fa15{margin:0;font-size:1.75rem;font-weight:700}.filters.jsx-c78748c6da78fa15{gap:var(--space-4);flex-wrap:wrap;align-items:flex-end;display:flex}.filter-group.jsx-c78748c6da78fa15{gap:var(--space-2);display:grid}.chip-group.jsx-c78748c6da78fa15{gap:var(--space-2);flex-wrap:wrap;display:flex}.chip.jsx-c78748c6da78fa15{padding:var(--space-2)var(--space-3);border-radius:var(--radius-sm);color:var(--color-deep-blue);cursor:pointer;background:#2563eb14;border:none;font-weight:500;transition:transform .15s,background .15s}.chip.jsx-c78748c6da78fa15:hover,.chip.jsx-c78748c6da78fa15:focus-visible{background:#0ea5e940;transform:translateY(-1px)}.chip.active.jsx-c78748c6da78fa15{background:var(--color-deep-blue);color:#fff;box-shadow:var(--shadow-card)}.search.jsx-c78748c6da78fa15 input.jsx-c78748c6da78fa15{padding:var(--space-2)var(--space-3);border-radius:var(--radius-sm);border:1px solid #2563eb2e;min-width:260px}.header.jsx-c78748c6da78fa15{justify-content:space-between;align-items:center;gap:var(--space-3);display:flex}.score.jsx-c78748c6da78fa15{color:var(--color-deep-blue);font-weight:600}.explainability.jsx-c78748c6da78fa15 ul.jsx-c78748c6da78fa15,.actions.jsx-c78748c6da78fa15 ul.jsx-c78748c6da78fa15{gap:var(--space-2);margin:0;padding:0;list-style:none;display:grid}.explainability.jsx-c78748c6da78fa15 li.jsx-c78748c6da78fa15{gap:2px;display:grid}.explainability.jsx-c78748c6da78fa15 strong.jsx-c78748c6da78fa15{text-transform:uppercase;letter-spacing:.08em;color:var(--color-neutral-2);font-size:.75rem}.explainability.jsx-c78748c6da78fa15 .weight.jsx-c78748c6da78fa15{color:var(--color-neutral-2);font-size:.75rem}.decision-bar.jsx-c78748c6da78fa15{justify-content:space-between;align-items:center;gap:var(--space-3);margin-top:var(--space-4);display:flex}.buttons.jsx-c78748c6da78fa15{gap:var(--space-2);display:flex}.decision-button.jsx-c78748c6da78fa15{border-radius:var(--radius-sm);padding:var(--space-2)var(--space-3);cursor:pointer;color:var(--color-deep-blue);background:#2563eb14;border:none;font-weight:600;transition:background .2s}.decision-button.approve.selected.jsx-c78748c6da78fa15,.decision-button.approve.jsx-c78748c6da78fa15:hover{background:#0ea5e933}.decision-button.reject.selected.jsx-c78748c6da78fa15,.decision-button.reject.jsx-c78748c6da78fa15:hover{background:#ef635133}.metadata.jsx-c78748c6da78fa15{gap:var(--space-2);margin-top:var(--space-4);grid-template-columns:repeat(auto-fit,minmax(120px,1fr));display:grid}.metadata.jsx-c78748c6da78fa15 dt.jsx-c78748c6da78fa15{letter-spacing:.08em;text-transform:uppercase;color:var(--color-neutral-2);margin:0;font-size:.75rem}.metadata.jsx-c78748c6da78fa15 dd.jsx-c78748c6da78fa15{margin:0;font-weight:600}@media (width<=960px){.summary-grid.jsx-c78748c6da78fa15{grid-template-columns:repeat(auto-fit,minmax(140px,1fr))}.filters.jsx-c78748c6da78fa15{flex-direction:column;align-items:stretch}.search.jsx-c78748c6da78fa15 input.jsx-c78748c6da78fa15{width:100%}}"
            }, void 0, false, void 0, this)
        ]
    }, void 0, true, {
        fileName: "[project]/Desktop/Bmad-Method/apps/web/app/recommendations/page.tsx",
...
_s(RecommendationsPage, "p3rCOM+3cZ0W0SJJnkKXWUffHG8=");
...
//# sourceMappingURL=Desktop_Bmad-Method_apps_web_5c5ca5de._.js.map