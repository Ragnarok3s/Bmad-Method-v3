...
| ID | Epic / Área | Item de Backlog | Critérios de Aceite | Dependências | Status DoR (2024-07-22) |
|----|-------------|-----------------|---------------------|---------------|-----------------------|
| BL-HK01 | Housekeeping Móvel | Disponibilizar app responsivo/offline para staff registrar status de quartos e amenities | Staff consegue atualizar tarefas em < 2 minutos, mesmo offline; sincronização automática ao recuperar conexão; histórico visível para gestores. | Design mobile; APIs de inventário; mecanismo de sincronização | ✅ Revalidação DoR 2024-07-22 registrada em [DoR Housekeeping](evidencias/dor-housekeeping-validacoes.md#bl-hk01-housekeeping-movel), com dependências técnicas assinadas e plano de sincronização offline aprovado. |
| BL-HK02 | Integrações Housekeeping-Parceiros | Conectar app de housekeeping a parceiros de lavanderia e manutenção com SLAs definidos | Agendamentos enviados com janela acordada; confirmação automática registrada; alertas para violações de SLA. | SLAs com parceiros formalizados; webhooks ou APIs de parceiros | ✅ Revalidação DoR 2024-07-22 documentada em [DoR Housekeeping](evidencias/dor-housekeeping-validacoes.md#bl-hk02-integracoes-housekeeping-parceiros), com contratos atualizados e webhooks homologados. |
| BL-01 | Onboarding | Criar wizard de onboarding guiado para novos workspaces | Usuário conclui onboarding em < 5 minutos; coleta dados básicos de equipe; dispara checklist inicial. | Design UX aprovado; APIs de cadastro estáveis | ✅ Revalidado em 2024-07-22 no pacote [DoR Sprint 1](evidencias/dor-sprint1-validacoes.md#bl-01-onboarding), incluindo check-list de acessibilidade atualizado e testes smoke rerun. |
...
| BL-04 | Observabilidade | Integrar com pipeline de logs e métricas para agentes críticos | Logs enviados para stack central; dashboards default criados; alertas críticos configurados. | Ferramentas de observabilidade definidas | ✅ Revalidação DoR 2024-07-22 em [DoR Sprint 1](evidencias/dor-sprint1-validacoes.md#bl-04-observabilidade-fundacional), com cobertura de alertas revisada e SLAs reconfirmados com Platform Engineering. |
| BL-05 | Governança | Configurar papéis e permissões básicas para administradores e colaboradores | Perfis administradores conseguem gerenciar agentes e playbooks; colaboradores apenas executam | Infraestrutura de identidade | ✅ Revalidação DoR 2024-07-22 em [DoR Sprint 1](evidencias/dor-sprint1-validacoes.md#bl-05-governança-perfis-básicos), incluindo runbooks atualizados e owners confirmados. |
...
### Atualização 2024-07-22 — Priorização BL-HK confirmada e dependências auditadas

- **Confirmação com o Product Owner**: em 2024-07-22, Ana Ribeiro reforçou que os épicos `BL-HK01` e `BL-HK02` permanecem como prioridade máxima do MVP até a conclusão do ciclo Sprint 2. O status foi registrado na ata do steering, vinculado às RFCs `RFC-2024-07-22-HK-SYNC` e `RFC-2024-07-22-PARTNER-WEBHOOKS`, e refletido no board Jira `MVP-Hospitality`.
