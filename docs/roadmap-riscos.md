...
| Ausência de automação de rollback e tagging de custos | Aumento de MTTR em incidentes e falta de visibilidade financeira para FinOps | Média | Concluir scripts de rollback no Terraform, habilitar tagging automático e validar logs em `docs/evidencias/sla-operacionais-2024-07.md`. | Pedro Barros (DevOps) | 10/07/2024 | ✅ Concluído em 07/11/2025 (artefatos `validation`/`rollback` atualizados) |
